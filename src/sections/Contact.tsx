        ...
        <Reveal delay={0.2}>
          <div className="mx-auto mt-14 max-w-3xl rounded-2xl bg-navy-900 p-8 text-center sm:p-10">
            ...
            <p className="mt-3 leading-relaxed text-navy-200">
              The Foundation's administrative office in Ernakulam is open Monday
              through Friday, 9:00 AM to 5:00 PM. For enquiries outside office
              hours, write to us and our team will respond within one working
              day.
            </p>
          </div>
        </Reveal>
